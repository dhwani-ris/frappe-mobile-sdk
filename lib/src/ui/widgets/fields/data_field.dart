  ...
  Widget buildField(BuildContext context) {
    ...
    return FormBuilderTextField(
      ...
      decoration: style?.decoration ?? InputDecoration(
        ...
        helperText: isPhone ? 'Must include country code (e.g., +91 for India)' : null,
        helperMaxLines: 2,
      ),
      maxLength:
          (field.length != null && field.length! > 0) ? field.length : null,
      validator: field.reqd
          ? (value) {
              ...
              if (isPhone && value.isNotEmpty) {
                ...
                final cleaned = trimmed.substring(1).replaceAll(RegExp(r'[\s\-\(\)]'), '');
